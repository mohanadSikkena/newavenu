...
Widget build(BuildContext context) {
    ...
    return Scaffold(
      floatingActionButton: FloatingActionButton.extended(
        ...
        children: [
          Text('Contact Us',style: f15TextWhiteSemibold,), 
         const SizedBox(width: 8,),
          Icon(Icons.support_agent , color: white,)
        ],
      )
      ...
      children: [
        ...
        Padding(
                ...
                child: Image.asset(Theme.of(context).colorScheme.background==black? 'images/white_logo_crop.png':'images/black_logo_crop.png',height:50 ,alignment: Alignment.center),
              ),
              ...
              Flexible(
                  ...
                  child: Row(
                    ...
                    children: [
                      categoryWidget(name: Constant.categories[0]['name'], image:Constant.categories[0]['img'] , function: (){
                        LocationCubit.get(context).navigateToPrimaryCategories(context:context);
                      }),
                      categoryWidget(name: Constant.categories[1]['name'], image:Constant.categories[1]['img'] , function: (){
                       CategoriesCubit.get(context).navigateToCategories(context: context);
                      })
                  ],)
                ...
                ,
                const SizedBox(height: 16,),
                BlocBuilder<AdsCubit,AdsStates>(builder:(context, states){
                return AdsCubit.get(context).adsLoading? customLoading():
                ...
                height: 320,
                  ...
                  itemBuilder: (context,i,j){
                    ...
                    return adWidget(context: context, ad: AdsCubit.get(context).ads[i])
