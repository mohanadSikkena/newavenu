          ...
          return Scaffold(
            ...
            body: cubit.primaryScreenLoading
                ...
                : AnnotatedRegion<SystemUiOverlayStyle>(
                    // value:SchedulerBinding.instance.window.platformBrightness==Brightness.dark?
                        ...
                        child:
                              ...
                              SizedBox(
                                ...
                                child: Align(
                                  ...
                                  child: AnimatedSmoothIndicator(
                                      ...
                                      count:
                                          cubit.currentPrimary.images.length),
                                ),
                              )
                            ],
                          ),
                          ...
                          Flexible(
                            child: Card(
                              ...
                              // shadowColor: ThemeData.dark(useMaterial3: true).shadowColor,
                              // elevation: 0.0,
                          ...
                          Flexible(
                            child: Card(
                              child: GridView.count(
                                ...
                                children: [
                                  customListTile(
                                      name: 'Min Price per meter',
                                      data: cubit
                                          .currentPrimary.minPricePerMeter),
                                  customListTile(
                                      name: 'Max Price Per meter',
                                      data: cubit
                                          .currentPrimary.maxPricePerMeter),
                                  customListTile(
                                      name: 'Min Total price',
                            ...
                            child: Card(
                              child: GridView.count(
                                ...
                                children: [
                                  customListTile(
                                      name: 'Min Space',
                                      data: cubit.currentPrimary.minSpace),
                                  customListTile(
                                      name: 'Max Space',
                                      data: cubit.currentPrimary.maxSpace),
                                  customListTile(
                                      name: 'Delivery Date',
                                      data: cubit.currentPrimary.deliveryDate),
                                      ...
                                      child: InkWell(
                                        onTap: () async {
                                          await LauncherHelper.launchWhatsapp(
                                              context: context, category: 'primary', id: cubit.currentPrimary.id);
